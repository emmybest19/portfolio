...
const Services = () => {
  ...
  return (
    <section  className="py-20 bg-white relative dark:bg-inherit mt-8">
      <div className="max-w-7xl mx-auto px-4 text-center ">
        <h2 className="text-3xl font-bold text-gray-800 mb-4 dark:text-white/60" data-aos="fade" data-aos-duration="2000"
        data-aos-delay="1000"
        >What I Do</h2>
        <p className="text-gray-600 mb-12 dark:text-white/60" data-aos="slide-right"
        data-aos-delay="1000"
        ...
        <div className="relative px-4">
          ...
          <div
            ...
            className="flex justify-between whitespace-nowrap px-4 py-4 "
